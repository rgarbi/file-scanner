...
#[tracing::instrument(name = "Select a file that needs hashing", skip(file_scan, pool))]
pub async fn select_a_file_that_needs_hashing(file_scan: FileScan, pool: &PgPool) -> Result<Uuid, Error> {
    sqlx::query!(
